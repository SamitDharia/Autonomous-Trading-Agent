...
class ProbRSISkeleton(QCAlgorithm):
    def Initialize(self) -> None:
        # Use a local data set that exists in this repo: FXCM EURUSD minute data (2014)
        self.SetStartDate(2014, 5, 5)
        self.SetEndDate(2014, 5, 30)
        self.SetCash(100000)

        # EURUSD forex pair (data present under data/forex/fxcm/minute/eurusd)
        ...
        self.use_brain = False  # toggle off to force the dummy RSI rule locally
